...
//Admin Dashboard
// Bypassing all middleware and requirements for admin dashboard
Route::group(['prefix' => 'admin'], function() {

    // Directly access admin dashboard without middleware checks
    Route::get('/dashboard', AdminDashboardIndex::class)->name('admin.dashboard.index');
    
    // Optionally, you can add other admin routes here as needed without middleware
